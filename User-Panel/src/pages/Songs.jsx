    ...
    <div className="flex min-h-screen bg-black text-white overflow-hidden">
      ...
      <div className="flex-1 min-w-0 flex flex-col bg-gradient-to-b from-[#121212] via-black to-[#0d0d0d]">
        ...
        <div className="flex-1 overflow-y-auto px-4 sm:px-6 md:px-8 lg:px-10 py-6 sm:py-8 pb-24 md:pb-10">
          ...
          {/* Hero Section */}
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-green-500/20 via-emerald-400/10 to-transparent border border-green-500/10 p-6 sm:p-8 lg:p-10 mb-10 lg:mb-14 shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <h1 className="max-w-5xl text-3xl sm:text-5xl lg:text-7xl font-black leading-tight">
                Listen To The Best{" "}
              ...
              {/* Stats */}
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-8 lg:mt-10">

                <div className="flex items-center gap-3 bg-[#181818]/60 rounded-2xl p-4">
                ...
                <div className="flex items-center gap-3 bg-[#181818]/60 rounded-2xl p-4 sm:col-span-2 lg:col-span-1">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-5 mb-8">
            ...
            <div className="bg-[#181818] border border-[#2a2a2a] px-4 sm:px-5 py-3 rounded-full shadow-lg w-fit">
