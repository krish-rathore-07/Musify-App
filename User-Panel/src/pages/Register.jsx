...
const Register = () => {
  ...
  return (
    <div className="relative min-h-screen bg-black flex items-center justify-center overflow-hidden px-4 py-8">
      ...
      {/* Background Glow */}
      <div className="absolute -top-24 -left-24 w-64 h-64 sm:w-80 sm:h-80 md:w-[450px] md:h-[450px] bg-green-500/20 blur-3xl rounded-full"></div>

      <div className="absolute -bottom-24 -right-24 w-64 h-64 sm:w-80 sm:h-80 md:w-[450px] md:h-[450px] bg-emerald-400/10 blur-3xl rounded-full"></div>

      {/* Register Card */}
      <form
        onSubmit={handleRegister}
        className="relative z-10 w-full max-w-[450px] bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl shadow-2xl p-6 sm:p-8 md:p-10 flex flex-col gap-6"
      >
        ...
        <div className="flex flex-col items-center">
          ...
          <h1 className="text-3xl sm:text-4xl font-black text-white mt-5 text-center">
            Create Account
          </h1>

          <p className="text-gray-400 mt-3 text-center text-sm sm:text-base max-w-sm">
            Join Musify and experience your favorite music in a whole new way.
          </p>
        ...
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            value={email}
            onChange={(e) => setEmail(e.target.value)}
            className="bg-[#181818] border border-[#2a2a2a] focus:border-green-500 outline-none text-white p-3 sm:p-4 rounded-2xl transition-all duration-300"
            required
          />
        ...
        {/* Security Badge */}
        <div className="flex items-start sm:items-center gap-3 bg-[#181818] border border-[#2a2a2a] rounded-2xl p-4">

          <ShieldCheck className="text-green-400 w-6 h-6 shrink-0 mt-0.5 sm:mt-0" />
        ...
        <button
          type="submit"
          className="bg-green-500 hover:bg-green-400 transition-all duration-300 text-black font-bold py-3 sm:py-4 rounded-2xl shadow-lg hover:shadow-green-500/30 text-base sm:text-lg"
        >
          Create Account
        </button>
