...
const Navbar = () => {
  ...
  return (
    <div className="sticky top-0 z-50 bg-black/70 backdrop-blur-xl border-b border-white/10 shadow-lg">
      ...
      <div className="flex items-center justify-between gap-3 px-3 sm:px-5 lg:px-6 py-3 sm:py-4">
        ...
        <div className="flex items-center gap-2 sm:gap-3 shrink-0">
          ...
          <button
            onClick={() => navigate(-1)}
            className="w-10 h-10 sm:w-11 sm:h-11 rounded-full bg-[#181818] hover:bg-[#282828] transition duration-300 flex items-center justify-center shadow-md"
          >
            <ChevronLeft className="text-white w-5 h-5" />
          </button>
        ...
        <form
          onSubmit={handleSearch}
          className="hidden md:flex flex-1 max-w-xl items-center bg-[#181818] border border-[#2a2a2a] focus-within:border-green-500 transition rounded-full px-4 py-3 shadow-lg mx-4"
        >
        ...
        <div className="flex items-center gap-2 sm:gap-4 shrink-0">
          ...
          {/* User */}
          <div className="hidden lg:flex items-center gap-3 bg-[#181818] border border-[#2a2a2a] px-4 py-2 rounded-full shadow-md">
          ...
          <button
            onClick={logout}
            className="bg-gradient-to-r from-red-500 to-pink-500 hover:scale-105 transition-all duration-300 px-3 sm:px-5 py-2.5 sm:py-3 rounded-full shadow-lg flex items-center gap-2 font-semibold"
          >
      ...
      <div className="md:hidden px-3 pb-3">
        ...
        <form
          onSubmit={handleSearch}
          className="flex items-center bg-[#181818] border border-[#2a2a2a] focus-within:border-green-500 transition rounded-full px-4 py-3 shadow-lg"
        >
