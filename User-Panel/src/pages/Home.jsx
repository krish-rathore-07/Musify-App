...
const Home = () => {
  ...
  return (
    <div className="flex min-h-screen bg-black text-white overflow-hidden">
      ...
      {/* Main Content */}
      <div className="flex-1 flex flex-col min-w-0 bg-gradient-to-b from-[#121212] via-[#181818] to-black">

        {/* Navbar */}
        <Navbar />

        {/* Scrollable Content */}
        <div className="flex-1 overflow-y-auto px-4 py-5 sm:px-6 sm:py-6 md:px-8 lg:px-10 lg:py-8">

          {/* Hero Section */}
          <div className="relative overflow-hidden rounded-3xl border border-green-500/10 bg-gradient-to-r from-green-500/20 via-emerald-400/10 to-transparent p-6 sm:p-8 lg:p-10 mb-8 lg:mb-12 shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <button className="mt-7 rounded-full bg-green-500 hover:bg-green-400 transition duration-300 text-black font-bold px-6 py-3 sm:px-8 sm:py-4 shadow-lg hover:shadow-green-500/40">
                Start Listening
              </button>
          ...
          <div className="mb-12 lg:mb-16">
            ...
            <div className="flex items-center justify-between gap-4 mb-6 lg:mb-8">
              ...
              <button className="text-sm sm:text-base text-gray-400 hover:text-white transition whitespace-nowrap">
                Show All
              </button>
          ...
          <div>
            ...
            <div className="flex gap-4 sm:gap-6 overflow-x-auto pb-8 lg:pb-10 scrollbar-hide">
