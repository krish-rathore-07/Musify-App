...
const Search = () => {
 ...
 <div className="flex bg-black text-white min-h-screen overflow-hidden">
    ...
    {/* Main Content */}
    <div className="flex-1 min-w-0 flex flex-col bg-gradient-to-b from-[#121212] via-black to-[#0d0d0d]">

      {/* Navbar */}
      <Navbar />

      {/* Search Content */}
      <div className="flex-1 overflow-y-auto px-4 sm:px-6 md:px-8 lg:px-10 py-6 sm:py-8 pb-24 md:pb-10">

        {/* Everything currently inside your Search page */}
<div className="min-h-screen bg-gradient-to-b from-[#121212] via-black to-[#0d0d0d] text-white px-4 sm:px-6 md:px-8 lg:px-10 py-6 sm:py-8 lg:py-10">

      {/* Hero */}
      <div className="relative overflow-hidden rounded-3xl border border-green-500/10 bg-gradient-to-r from-green-500/20 via-emerald-400/10 to-transparent p-6 sm:p-8 lg:p-10 mb-10 lg:mb-14 shadow-2xl">

        {/* Glow */}
        <div className="absolute -top-20 -right-20 w-56 h-56 sm:w-72 sm:h-72 bg-green-500/20 blur-3xl rounded-full"></div>

        <div className="relative z-10">

          <div className="flex items-center gap-3 mb-5">

            <Sparkles className="text-green-400 w-6 h-6 sm:w-8 sm:h-8" />
          ...
          <h1 className="max-w-4xl text-3xl sm:text-5xl lg:text-7xl font-black leading-tight">
          ...
          <p className="text-gray-400 text-sm sm:text-base lg:text-lg mt-5 sm:mt-6 max-w-2xl leading-relaxed">
            Discover trending tracks, artists, and albums instantly with Musify.
          </p>

          {/* Search Input */}
          <div className="mt-8 sm:mt-10 flex items-center bg-[#181818] border border-[#2a2a2a] focus-within:border-green-500 transition rounded-full px-4 sm:px-5 py-3 sm:py-4 max-w-2xl shadow-2xl">

            <SearchIcon className="text-gray-400 w-5 h-5 sm:w-6 sm:h-6 shrink-0" />
            ...
            <input
              ...
              value={query}
              onChange={(e) => setQuery(e.target.value)}
              className="bg-transparent text-white placeholder-gray-500 outline-none ml-3 sm:ml-4 w-full text-sm sm:text-lg"
            />
      ...
      <div className="mb-12 lg:mb-16">
        ...
        <div className="flex flex-wrap items-center gap-3 mb-6 lg:mb-8">
          ...
          <Music2 className="text-green-400 w-6 h-6 sm:w-8 sm:h-8" />
        ...
        {filteredSongs.length > 0 ? (
          ...
          <div className="bg-[#181818] border border-[#2a2a2a] rounded-3xl p-6 sm:p-10 text-center text-gray-400 text-base sm:text-lg">
            No Songs Found
          </div>
      ...
      <div>
        ...
        <div className="flex flex-wrap items-center gap-3 mb-6 lg:mb-8">
          ...
          <Disc3 className="text-green-400 w-6 h-6 sm:w-8 sm:h-8" />
